...
//custom fetch hook
function useTodos() {
    const [initialtodos, setInitialTodos] = (0, react_1.useState)([]);
    (0, react_1.useEffect)(() => {
        const getTodos = () => __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch('http://localhost:3000/todo/todos', {
...
const TodoList = () => {
    ...
    const authStateValue = (0, recoil_1.useRecoilValue)(authState_js_1.authState);
    ...
    const addTodo = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (let i = 0; i < initialtodos.length; i++) {
            newTodos.push(initialtodos[i]);
        }
        newTodos.push(data);
        setTodos(newTodos);
    });
    //@ts-ignore //to ignore types 
    const markDone = (id) => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield fetch(`http://localhost:3000/todo/todos/${id}/done`, {
            method: 'PATCH',
            headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }
        });
    ...
    return (<div>
            ...
            {initialtodos.map((todo) => (<div key={todo._id}>
                    <h3>{todo.title}</h3>
